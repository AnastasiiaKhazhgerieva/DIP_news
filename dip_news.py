...
#with open('ria.json', encoding='utf-8') as f:
#    data = json.load(f)
...
section_to_prompt_design_finish = {
    "world": [
        'Пожалуйста, оформи нумерованный список для раздела по мировой экономике в соответствии с требованиями к оформлению буллитов. Пришли итоговый результат текстом в виде списка вроде такого: 1. Название новости \n URL. \n'
    ],
    "rus": [
        'Пожалуйста, оформи нумерованный список для раздела по россиийской экономике в соответствии с требованиями к оформлению буллитов. Пришли итоговый результат текстом в виде списка вроде такого: 1. Название новости \n URL. \n.'
    ],
    "prices": [
        'Пожалуйста, оформи нумерованный список для раздела по новостям, релевантным для динамики российских цен, в соответствии с требованиями к оформлению буллитов. Пришли итоговый результат текстомв виде списка вроде такого: 1. Название новости \n URL. \n.'
    ]
}
