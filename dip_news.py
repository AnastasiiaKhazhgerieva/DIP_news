...
section_to_prompt_design_finish = {
    "world": [
        'Пожалуйста, оформи нумерованный список для раздела по мировой экономике в соответствии с требованиями к оформлению буллитов. Пришли итоговый результат текстом.'
    ],
    "rus": [
        'Пожалуйста, оформи нумерованный список для раздела по россиийской экономике в соответствии с требованиями к оформлению буллитов. Пришли итоговый результат текстом.'
    ],
    "prices": [
        'Пожалуйста, оформи нумерованный список для раздела по новостям, релевантным для динамики российских цен, в соответствии с требованиями к оформлению буллитов. Пришли итоговый результат текстом.'
    ]
}
